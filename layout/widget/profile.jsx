...
class Profile extends Component {
    ...
    return (
      <div class='level is-mobile is-multiline'>
        {links
          ...
          .map((link) => {
            return (
              <a class='level-item button is-transparent is-marginless' target='_blank' rel='noopener' title={link.name} href={link.url}>
  ...
  render() {
    const { avatar, avatarRounded, author, authorTitle, location, locationLink, counter, followLink, followTitle, socialLinks } = this.props;
    return (
              ...
              <div>
                ...
                {location ? (
                  <p class='is-size-6 is-flex justify-content-center'>
                    {locationLink ? (
                      <a target='_blank' class='link-muted' href={locationLink}>
